# Generated by Django 3.1 on 2020-12-23 18:18
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('FechaNacimiento', models.DateField(default=datetime.date(2020, 12, 23))),
                ('Cedula', models.CharField(max_length=11, validators=[django.core.validators.RegexValidator(code='nomatch', message='Length has to be 11', regex='^.{11}$')])),
                ('FechaRegistro', models.DateTimeField(default=datetime.datetime(2020, 12, 23, 18, 18, 3, 917555, tzinfo=utc))),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('CedulaTutor', models.CharField(max_length=11, validators=[django.core.validators.RegexValidator(code='nomatch', message='Length has to be 11', regex='^.{11}$')])),
